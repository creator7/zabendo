   ...
   <div class = "carousel-inner">
      <div class = "item active" id="slide1">
         ...
         <div class="carousel-caption">
         	<h4>W4 Ranking Institute</h4>
            <p>Affiliated with engineering and medical councils</p>
         </div><!-- end carousel-caption-->
      </div>
      
      <div class = "item" id="slide2">
        <div class="carousel-caption">
         	<h4>Ranking in Pakistan</h4>
            <p>4th large university of Pakistan in private sector</p>
         </div><!-- end carousel-caption-->
      </div>
